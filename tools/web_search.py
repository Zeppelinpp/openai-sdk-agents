...
def web_reader(url: str):
    ...
    try:
        ...
        for tag in parser.css("script, style, noscript, iframe, nav, footer, header, aside, [class*='ad'], [class*='banner'], [class*='menu'], [class*='sidebar'], [class*='nav'], [id*='nav'], [id*='menu'], [id*='sidebar'], [id*='footer'], [id*='header']"):
            tag.decompose()
        ...
        if main_elements:
            ...
            for tag in parser.css("p, h1, h2, h3, h4, h5, h6, li"):
                ...
                if text and len(text) > 20:  # Filter out very short pieces that are likely navigation
                    main_content += text + "\n\n"
